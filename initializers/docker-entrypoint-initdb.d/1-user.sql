...
CREATE USER 's3_admin'@'localhost' IDENTIFIED with mysql_native_password BY 's3_PaSsW0Rd';
CREATE USER 's3_admin'@'192.168.66.%' IDENTIFIED with mysql_native_password  BY 's3_PaSsW0Rd';
